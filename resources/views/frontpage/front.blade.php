...
<div class="container">
    ...
    <div class="content c-news">
        <h5 class="kanit fronttitle red-text text-accent-4"> News <a class="waves-effect waves-light btn  red accent-4 kanit" href="{{url('news')}}"> ดูข่าวทั้งหมด </a> </h5><hr class="hr-front">
